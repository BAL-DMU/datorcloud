...
class DatorCloudOrchestrator:
    ...
    def __init__(
        ...
        # Initialize metadata generator component
        ...
        # Initialize metadata storage component
    ...
    def query_metadata(
        ...
        # Save the metadata file path for future use
    ...
    def retrieve_experiment(
        ...
        **filters
        ...
        """
        if metadata_file is None:
            metadata_file = getattr(self, "_last_metadata_file", 
                            f"s3://{self.metadata_bucket}/metadata.csv")
